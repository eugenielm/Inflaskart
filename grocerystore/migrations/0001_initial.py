...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_data', django.contrib.postgres.fields.jsonb.JSONField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_category_name', models.CharField(blank=True, default=None, max_length=30, verbose_name='product sub-category')),
                ('parent', models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, to='grocerystore.ProductCategory', verbose_name='top product category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip_city', models.CharField(default='Unknown city', max_length=50)),
                ('zip_state', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='grocerystore.State')),
            ],
        ),
        migrations.AddField(
            model_name='store',
