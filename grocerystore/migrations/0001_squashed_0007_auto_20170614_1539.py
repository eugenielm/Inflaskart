# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-06-15 23:56
...
class Migration(migrations.Migration):
    ...
    replaces = [('grocerystore', '0001_initial'), ('grocerystore', '0002_auto_20170510_2124'), ('grocerystore', '0003_auto_20170512_1549'), ('grocerystore', '0004_auto_20170512_1640'), ('grocerystore', '0005_auto_20170512_1918'), ('grocerystore', '0006_product_taxability'), ('grocerystore', '0007_auto_20170614_1539')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_location', models.CharField(default=None, max_length=30, verbose_name='location name')),
                ('store_address', models.CharField(default='Address unknown', max_length=200, verbose_name='Address')),
        ...
        migrations.AddField(
            model_name='store',
            name='delivery_area',
            field=models.ManyToManyField(to=b'grocerystore.Zipcode'),
        ),
        migrations.AddField(
            model_name='store',
            name='store_state',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to=b'grocerystore.Dietary'),
        ),
        migrations.AddField(
            model_name='product',
            name='product_store',
            field=models.ManyToManyField(through='grocerystore.Availability', to=b'grocerystore.Store', verbose_name='availability(ies) in store(s)'),
        ),
        migrations.AddField(
